<%@ Page Title="" Language="C#" MasterPageFile="~/View/Layout.Master" AutoEventWireup="true" CodeBehind="AddRamen.aspx.cs" Inherits="raamen.View.AddRamen" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Add Ramen - Raamen</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="min-height: 88vh" class="d-flex flex-column justify-content-center">
        <div class="form-wrapper">
            ...
            <div class="my-3">
                <a href="/ramen" class="btn m-0 p-0" role="button">
            ...
            <asp:Button ID="addRamenBtn" runat="server" Text="Add Ramen" CssClass="btn btn-primary btn-block w-100 mb-3" OnClick="addRamenBtn_Click" />
        </div>
    </div>
</asp:Content>
